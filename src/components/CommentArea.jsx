...
export default function CommentArea({film, }) {
...
const cancellaRecensione = (_id) => {
    ...
    return (
        <>
                ...
                <AddComment film={film} setValoreInput={setValoreInput} valoreInput={valoreInput} setRating={setRating} rating={rating} creaRecensione={creaRecensione} />
